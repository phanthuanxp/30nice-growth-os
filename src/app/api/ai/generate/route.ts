...
const SYSTEM_PROMPTS: Record<string, string> = {
  article:
    "Bạn là chuyên gia viết nội dung tiếng Việt cho website doanh nghiệp (taxi, dịch vụ, du lịch). Viết nội dung chất lượng cao, thân thiện SEO, tự nhiên và hữu ích. Độ dài khoảng 400-600 từ trừ khi được yêu cầu khác.",
  seo_meta:
